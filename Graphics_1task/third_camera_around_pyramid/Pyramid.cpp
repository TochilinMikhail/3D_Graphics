...
int main( void )
{
	...
	do{
		...
		float X_position = 2.5f * sin(1.5f * glfwGetTime());
		float Y_position = 1.5f * sin(0.7f * glfwGetTime());
		float Z_position = 2.5f * cos(1.5f * glfwGetTime());

		View = glm::lookAt(
			glm::vec3(X_position, Y_position, Z_position),
